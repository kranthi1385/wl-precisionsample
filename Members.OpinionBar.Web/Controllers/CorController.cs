...
namespace Members.OpinionBar.Web.Controllers
{
    ...
    public class CorController : BaseController
    {
        ...
        {
            User objUser = new Components.Entities.User();
        ...
        public ActionResult s1(int rid, string txid, string sid, string fid, string trans_id, string fn, string ln, string em, string dob, string lname, string prjid)
        {
            ...
            if (authkey.ToLower() == "71CC02CD-B8A5-4A5A-AF4D-9988B2F21761".ToLower())
            {
                ...
                ViewBag.Logo = "https://widget.reachcollective.com/Images/Conversant_Logo.png";
            ...
            else
            {
                ...
                ViewBag.Logo = "https://widget.reachcollective.com/Images/opinionbar_logo.png";
        ...
        public ActionResult msglb(int rid, string txid, string into, string sid, string fid, string trans_id, string prjid)
        {
            ...
            logger.Info("SkiptoSurvey: " + authkey + " | IP Address: " + HttpContext.Request.Headers["X-Forwarded-For"].ToString());
            ViewBag.SkiptoSurvey = authkey;
        ...
        #region Get Survey URL for Router
        [Route("GetSurveyURL")]
        [ValidateJsonAntiForgeryToken]
        [HttpGet]
        public string GetSurveyURL(int pid, int rid, string extid)
        {
            ...
            surveyUrl = objManager.GetSurveyURL(pid, rid, IpAddress[0], userTrafficTypeId, mobiledeviceModel, browserInfo, Request.UserAgent,extid);
            return surveyUrl;
        }
        #endregion
    }
