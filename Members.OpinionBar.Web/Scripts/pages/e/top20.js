...
var LoadQtns = function () {
    ...
    prjid = getUrlVars()["prjid"];
    if (prjid == undefined) {
        prjid = '0';
    }
    pg = getUrlVars()["pg"] //user status guid added 06/13/2016
    if (pg == undefined) {
        pg = '';
    }
    ...
    var bindQuestions = function () {
        $.ajax({
            url: '/Cor/Top20Get?ug=' + ug + '&pg=' + pg + '&ispeerly2=' + 0,
            type: 'GET',
            headers: {
            ...
            success: function (Pagedata) {
                ...
                if (Pagedata != null) {
                    if (Pagedata[0].QuestionId > 0) { // if member answered all questions then redirect to next page
                        ...
                        if (cid == 541) //OB login
                        {
                            window.location.href = 'https://www.opinionbar.com/Home/LogIn?leadid=' + ug
                        }
                        else {
                            window.location.href = 'https://www.conversant.pro/registration?leadid=' + ug
                        }
                    }
                }
                else {
    ...
    var SurveyQuestion = function (questions) {
        ...
        selectionChanged = function (event) {
            ...
            if (_ddlclick == 0) {
                if (event.OptionId != null && event.OptionId != '' && event.OptionId != undefined) {
                    ...
                    $("#" + event.QuestionId + '_trChildQuestionId')
        ...
        Save = function () {
            ...
            for (var i = 0; i < Self.Questions().length; i++) {
                ...
                if (ViewModel.Questions()[9] != null) {
                    if (ViewModel.Questions()[9].QuestionId == 5110) {
                        if (Self.Questions()[9].ChildQuestionList[0].OptionList[0].IsChecked == false && Self.Questions()[9].ChildQuestionList[0].OptionList[1].IsChecked == false) {
                            isValid = false;
                        }
                    }
                }
            ...
            if (isValid == true) {
                ...
                $.ajax({
                    ...
                    success: function (pagedata) {
                        ...
                        //  alert(pagedata);
                        if (pagedata == "dupesuccess") {

                            if (cid == 541) //OB login
                            {
                                window.location.href = '/Home/LogIn?leadid=' + ug;
                            }
                            else {
                                window.location.href = 'https://www.conversant.pro/registration?leadid=' + ug
                            } //Conversant Login
                            ...
                            //Continue to take next survey.
                            if (prjid > 0) {
                                window.location.href = 'https://widget.reachcollective.com/survey/entry?mid=' + ug + '&isp2=t&project=' + prjid + '&key=' + pg;
                            }
                            else {
                                window.location.href = '/cor/surveyget?userGuid=' + ug + '&authkey=' + pg + '&isp2=f' + "&prjid=" + prjid;
                            }
                        }
                    }
                });
