            ...
            if (res.length > 0) {
                ...
                if (res[0].RedirectUrl != "" && res[0].RedirectUrl != null) {
                    ...
                    if (res[0].QuestionId == -1) {
                        ...
                        $rootScope.isShowFooter = $scope.questions[0].OrgId !== 7191;
                        $rootScope.isShowOrgLogo = $scope.questions[0].OrgId == 7191 ? false : $rootScope.isShowOrgLogo;
                        ...
                        if (dataResponse.UserInvitationGuid != "" && dataResponse.UserInvitationGuid != undefined) {
                            ...
                            httpService.getData('/prs/takeanothersurvey?ug=' + ug + '&cid=' + cid + '&uig=' + dataResponse.UserInvitationGuid).then(function (dataResponse1) {
                                ...
                                if (cid == 110) {
                                    ...
                                    window.location.href = 'https://e.reachcollective.com/e/psr?usg=2B9038B6-DB53-429A-8854-7BB83338B2D4&uig=' + dataResponse.UserInvitationGuid;
                                }
                            })
                        }
                    })
