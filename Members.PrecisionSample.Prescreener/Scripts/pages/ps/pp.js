...
var LoadBasicQtns = function () {
        ...
        if (Pagedata.length != 0) {
            ...
            if (Pagedata[0].IsFraud == false) {
                if (Pagedata[0].QuestionId > 0) { // if member answered all questions then redirect to next page
                    ...
                    //redirect urls
                    if (Pagedata[0].IsShowCCPA == false && cid != 728 && cid != 450 && cid != 541 && cid != 542 && cid != 162 && cid != 668 && cid != 645 && cid != 680 && cid != 707 && cid != 681 && cid != 501) {
                ...
                window.location.href = "http://e.reachcollective.com/e/psr?usg=EF75E92A-2A50-477F-9342-E6E597469B4A&uig=" + Pagedata[0].UserInvitationGuid + '&ug=' + ug + '&pid=' + pid + '&cid=' + cid; //redirect to endpage
            }
    ...
    var SurveyQuestion = function (questions) {
        ...
        Privacy = function () {
            $window.open('https://widget.reachcollective.com/Partner/Privacy.htm', 'SurveyDownline-Privacy', 'width=800,height=800')
        }
