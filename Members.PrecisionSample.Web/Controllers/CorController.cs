...
namespace Members.PrecisionSample.Web.Controllers
{
    ...
    public class CorController : BaseController
    {
        ...
        public ActionResult s1(int rid, string txid, string sid, string fid, string trans_id, string fn, string ln, string em, string dob, string lname, string prjid)
        {
            ...
            string authkey = objManager.InsertAffClicks(rid, txid, IpAddress, sid, fid, trans_id, RefererUrl);
        ...
        public ActionResult login(string leadid,string is_t,string pc,string extid)
        {
            return View("/Views/cor/login.cshtml");
        }
        public ActionResult msglb(int rid, string into, string prjid)
        {
        ...
        public ActionResult ps2(int rid, string txid, string sid, string fid, string trans_id, string fn, string ln, string em, string dob, string lname)
        {
            string authkey = objManager.InsertAffClicks(rid, txid, IpAddress, sid, fid, trans_id, RefererUrl);
            if (authkey.ToLower() == "71CC02CD-B8A5-4A5A-AF4D-9988B2F21761".ToLower())
            {
