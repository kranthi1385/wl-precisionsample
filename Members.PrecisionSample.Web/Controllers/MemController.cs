...
namespace Members.PrecisionSample.Web.Controllers
{
    public class MemController : Controller
    {
        ...
        {
            return View("/views/Render/Profile.cshtml");
        }
        ...
        [HttpGet]
        public JsonResult ProfileGet(string pid, Guid ug, int cid)
        {
            ...
            var Pagedata = objQuestionBl.GetProfileQuestions(new Guid(pid), ug, cid);
