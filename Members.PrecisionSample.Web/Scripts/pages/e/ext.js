...
define(['app'], function (app) {
   ...
   function ($scope, $rootScope, $window, $timeout, httpService, getQueryParams, $interval) {
       ...
       var country = getQueryParams.getUrlVars()['country'];
       var age = getQueryParams.getUrlVars()['age'];
       var gender = getQueryParams.getUrlVars()['gender'];
       var income = getQueryParams.getUrlVars()['income'];
       var ethnicity = getQueryParams.getUrlVars()['ethnicity'];
       var hhi = getQueryParams.getUrlVars()['hhi'];
       var email = getQueryParams.getUrlVars()['hem'];
       var education = getQueryParams.getUrlVars()['education'];
       var hispanic = getQueryParams.getUrlVars()['hispanic'];
       if (hash == undefined) {
           hash = 0;
       }
       ...
       if (hhi == undefined) { hhi = ''; }
       if (email == undefined) { email = ''; }
       if (education == undefined) { education = ''; }
       if (hispanic == undefined) { hispanic = ''; }
       var rvid = '';
       var score = '';
       ...
       function saveRid() {
           ...
           if (mid != undefined || pid != undefined) {
               httpService.postData("/e/ExtUpdate?qg=" + qg + "&mid=" + mid + '&pid=' + pid + '&rid=' + rid + '&source=' + source + '&subId=' + subId + '&isNew=' + isNew +
                          ...
                          "&hash=" + hash + "&country=" + country + "&age=" + age + "&gender=" + gender + "&income=" + income + "&ethnicity=" + ethnicity + "&hhi=" + hhi +
                          "&email=" + email + "&education=" + education + "&hispanic=" + hispanic ).then(function (data, status) {
                                           ...
                                           if ($scope.surveyResponse.RedirectUrl == "") {
                                               ...
                                               if (deviceMatchedCount == 1 && isMobile == 2) {
                                                   if ($scope.surveyResponse.IsStandalone) {
                                                       ...
                                                       window.location.href = "https://widget.reachcollective.com/reg/home?ug=" + ug + "&cid=" + cid; //redirect to mobile survey page
                                                   }
                                               }
