...
namespace Members.PrecisionSample.Components.Data_Layer
{
    public class UserDataServices
    {
        ...
        /// <returns></returns>
        public int ReleventUpdateForSDLOrWL(Guid UserGuid, int RelevantScore, int PfScore, string FpfScore, string RelevantId, int ClientId, string VerityId, int VerityScore, int GeoCorrelationFlag, bool VerityDOBFail, string sessionResponse)
        {
            int Count = 0;
            SqlConnection cn = new SqlConnection();
            UserDataServices objDataServer = new UserDataServices();
            ...
            try
            {
                ...
                cm.Parameters.AddWithValue("@verisoul_json", sessionResponse);
                using (IDataReader reader = cm.ExecuteReader())
                {
                    while (reader.Read())
                    {
        ...
        /// <param name="RelevantId"></param>
        /// <returns></returns>
        public int ReleventUpdate(Guid UserGuid, int RelevantScore, int PfScore, string FpfScore, string RelevantId, int ClientId, string sessionResponse)
        {
            int Count = 0;
            SqlConnection cn = new SqlConnection();
            UserDataServices objDataServer = new UserDataServices();
