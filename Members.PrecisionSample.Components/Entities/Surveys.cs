...
namespace Members.PrecisionSample.Components.Entities
{
    public class Surveys
    {
        ...
        public string SurveyTrafficType { get; set; }
        ...
        public bool AccessMillCookie { get; set; }
        public bool ComScoreCookie { get; set; }
        public bool ResonateCookie { get; set; }
        public bool TapadCookie { get; set; }
        public string Cstring { get; set; }
        public Int64 UsrInvitaitonID { get; set; }
        public bool IPSOSisEligible { get; set; }
        public bool Is_simplify_affiliate { get; set; }
        public bool Is_peerly2_affiliate { get; set; }
        public Guid ClientKey { get; set; }
        public Int32 EncryptionTypeID { get; set; }
        public decimal ZipRadius { get; set; }
        public string QSFSurveyURL { get; set; }
        #endregion
    }
    public class ExtMemberGuidChk
    {
