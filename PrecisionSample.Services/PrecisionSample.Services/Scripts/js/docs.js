(function() {
    ...
    $('li.method > div.title').click(function() {
		...
		var src = form.hasClass('expanded') ? '/css/images/up.png' : '/css/images/down.png';
    ...
    $('li.endpoint > h3.title div.name').click(function() {
		...
		var src = endpoint.hasClass('expanded') ? '/css/images/up.png' : '/css/images/down.png';
    ...
    $('#toggle-endpoints').click(function(event) {
        ...
        if (endpointsLength > 0) {
            ...
            for (var x = 0; x < endpointsLength; x++) {
				...
				var src = methodsList.parent().hasClass('expanded') ? '/css/images/up.png' : '/css/images/down.png';
    ...
    $('#toggle-methods').click(function(event) {
        ...
        if (methodFormsLength > 0) {
            ...
            for (var y = 0; y < methodFormsLength; y++) {
		        ...
		        img.attr('src','/css/images/up.png');
            }
            ...
            for (var i = 0; i < visibleMethodFormsLength; i++) {
				...
				var img = method.parent().find('img.method-arrow');
		        img.attr('src','/css/images/down.png');
            }
        }
    ...
    $('li.expand-methods a').click(function(event) {
		...
		var img = endpoint.find('/css/images/img.arrow');
        img.attr('src',src);
