    ...
    class ExternalMemberDataLayer
    {
                          ...
                          string country, string age, string gender, string income, string ethnicity, string hhi, string email, string education, string hispanic)
        {
            ...
            try
            {
                ...
                {
                    cm.Parameters.AddWithValue("@age", DBNull.Value);
                }
                ...
                {
                    cm.Parameters.AddWithValue("@income", income);
                }
                else
                {
                    cm.Parameters.AddWithValue("@income", DBNull.Value);
                }
                if (!string.IsNullOrEmpty(ethnicity))
                {
                    cm.Parameters.AddWithValue("@ethnicity", ethnicity);
                }
                else
                {
                ...
                {
                    cm.Parameters.AddWithValue("@hhi", hhi);
                }
                else
                {
                    cm.Parameters.AddWithValue("@hhi", DBNull.Value);
                }
                ...
                {
                    cm.Parameters.AddWithValue("@education", education);
                }
                else
                {
                    cm.Parameters.AddWithValue("@education", DBNull.Value);
                }
                if (!string.IsNullOrEmpty(hispanic))
                {
                    cm.Parameters.AddWithValue("@hispanic", hispanic);
                }
                else
                {
                    cm.Parameters.AddWithValue("@hispanic", DBNull.Value);
                }
        ...
        public string CleanIDDataInsert(string uig, string ug, int pid, string extmid, int cid, string json, string sessionId, string sessionResponse)
        {
