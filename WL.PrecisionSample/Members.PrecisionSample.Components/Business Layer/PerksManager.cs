...
namespace Members.PrecisionSample.Components.Business_Layer
{
    public class PerksManager
    {
        ...
        /// <summary>
        /// data fetch page 4 offers
        /// </summary>
        /// <returns></returns>
        public List<Perks> GetPage4OfferDetails(int userid)
        {
            return oPerksDataServices.GetPage4OfferDetails(userid);
        }
        ...
        /// <param name="userid"></param>
        /// <returns></returns>
        public Perks InsertClickDate1(string PerkGuid, int UserId,string src, string UserGuid,int ClientId)
        {
