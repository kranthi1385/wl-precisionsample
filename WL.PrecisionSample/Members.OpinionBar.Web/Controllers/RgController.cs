...
namespace Members.OpinionBar.Web.Controllers
{
    public class RgController : BaseController
    {
        ...
        [HttpPost]
        public void saverelevantinfo(string ug, int score, string rvid, int pfScore, string fpfScores, int isNew, int rchecker, int cid, string token, string passParam, string geoLonLat, string pid, string userId, string sessionId = null)
        {
