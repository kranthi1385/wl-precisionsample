                            ...
                            if (parseInt($scope.trewards.RedeemAmount) <= parseInt($scope.trewards.AccountBalance)) {
                                ...
                                if ($scope.isPayPal) {
                                    if (parseInt($scope.trewards.RedeemAmount) >= $scope.trewards.MinRedemptionAmount) {
                                        ...
                                        httpService.getData('/mr/InserrtRewardRedeemprtions?amount=' + $scope.trewards.RedeemAmount + '&cg=' + $scope.cg, $scope.trewards.LstRewardAmount).then(function (data) {
                                            if (data == 0) {
                                    ...
                                    httpService.getData('/mr/RedeemMemberRewards?sku=' + $scope.sku + '&Ut=' + $scope.val + '&Points=' + _points + '&cid=' + cid).then(function (data) {
                                        if (data == 1) {
