...
var LoadQtns = function () {
    ...
    var bindQuestions = function () {
        $.ajax({
            url: '/Mem/ProfileGet?pid=' + pid + '&ug=' + ug + '&cid=' + cid,
            type: 'GET',
            headers: {
    ...
    var SurveyQuestion = function (questions) {
        ...
        Save = function () {
            ...
            if (pid == '2e6b8ae2-32b6-45a3-a65b-fc748d397e51') {
                for (var i = 0; i < Self.Questions().length; i++) {
            ...
            if (pid == '75a7b204-f92c-4e2e-bd04-5dafcd0d9b94') {
                for (var i = 0; i < Self.Questions().length; i++) {
            ...
            //saving data
            if (isValid == true) {
                if (isGDPRValid == true && gdprCheckbox == false && (pid == '2e6b8ae2-32b6-45a3-a65b-fc748d397e51' || pid == '75a7b204-f92c-4e2e-bd04-5dafcd0d9b94') && 
                    (conid == 505 || conid == 512 || conid == 525 || conid == 545 || conid == 548 || conid == 549 || conid ==550 || conid ==559 || conid ==564 || conid ==565 || conid ==572 || conid ==575 || conid ==590 || conid ==596 || conid ==599 || conid ==613 || conid ==618 || conid ==619 || conid ==620 || conid ==628 || conid == 647 || conid == 657 || conid == 668 || conid == 669 ||
