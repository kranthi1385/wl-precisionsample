...
namespace Members.PrecisionSample.Web.Controllers.partner
{
    ...
    public class RegController : BaseController
    {
        ...
        [HttpGet]
        public JsonResult RelevantUpdate(string ts, string ug, int pfscore, string rvid, string c, int cid, string ipqsJson)
        {
            int RelevantScore = 0;
            string FpfScores = string.Empty;
            ...
            var Pagedata = obj.ReleventUpdate(new Guid(ug), RelevantScore, pfscore, FpfScores, rvid, cid, ipqsJson);
            return Json(Pagedata, JsonRequestBehavior.AllowGet);
        }
        #endregion
