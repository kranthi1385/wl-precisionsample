...
namespace Members.NewOpinionBar.Web.Controllers
{
    ...
    public class EpController : BaseController
    {
        ...
        public JsonResult GetUserData()
        {
            ...
            logger.Trace("GetUserData|" + Identity.Current.UserData.UserGuid.ToString() + "ClientId" + MemberIdentity.Client.ClientId);
            logger.Trace("objuser|" + objuser.OrgId + "Org Name" + objuser.OrgName);            
        ...
        #region Delete User
        [System.Web.Http.Route("DeleteUserDataEmail")]
        [System.Web.Http.HttpPost]
