...
var LoadQtns = function () {
    ...
    issam = getUrlVars()["issam"];
    if (issam == undefined || issam == '') {
        issam = 'f';
    }
    ...
    leadid = getUrlVars()["leadid"] //user status guid added 06/13/2016
    if (leadid == undefined) {
        leadid = '';
    }
    ...
    var bindQuestions = function () {
        $.ajax({
            url: '/E/Top20Get?leadguid=' + leadid,
            type: 'GET',
            headers: {
        ...
        Save = function () {
            ...
            if (isValid == true) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: { xml: xml },
                    url: '/E/Top20Save?leadguid=' + leadid,
                    headers: {
                        '__RequestVerificationToken': document.getElementsByName("__RequestVerificationToken")[0].value
                    },
                    success: function (pagedata) {
                        window.location.href = 'https://e.reachcollective.com/e/lbs?leadid=' + leadid + '&pg=' + pg + '&is_t=' + 'h&issam='+ issam;
                    }
                });
            }
            else {
