   ...
   function ($rootScope, $scope, $window, $timeout, httpService, getQueryParams, translationsLoadingService, lazyscriptLoader, $cookies) {
                       ...
                       if ($scope.surveyResponse.RedirectUrl != null && $scope.surveyResponse.RedirectUrl != "" && $scope.surveyResponse.RedirectUrl.indexOf("5CE933ED-9891-4CD7-8AC6-B529C58C6B55") != -1) {
                           ...
                           if (deviceMatchedCount == 0 && isMobile == 2) {
                               if ($scope.surveyResponse.IsStandalone) {
                                   window.location.href = "http://e.reachcollective.com/e/psr?usg=5CE933ED-9891-4CD7-8AC6-B529C58C6B55&uig=" + $scope.surveyResponse.ActualInvitationGuid + '&ug=' + ug + '&pid=' + prjId + '&cid=' + cid; //redirect to endpage
                               }
                               else {
                                   window.location.href = "http://widget.reachcollective.com/reg/home?ug=" + ug + "&cid=" + cid; //redirect to mobile survey page
                               }
                           }
       ...
       function showSms() {
           ...
           if ($scope.surveyResponse.IsSmsInvitation) {
               ...
               window.location.href = "http://e.reachcollective.com/e/psr?usg=5CE933ED-9891-4CD7-8AC6-B529C58C6B55&uig=" + $scope.surveyResponse.ActualInvitationGuid + "&project=" + prjId + '&cid=' + cid; //redirect to endpage
